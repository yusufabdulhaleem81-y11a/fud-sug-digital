...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: '/about',
        element: ph('About SUG Digital', 'Phase H'),
      },
  ...
  // EXCO INVITATION PASSWORD SETUP
  {
  ...
  // STUDENT PORTAL
  {
    ...
    children: [
      ...
      {
        path: 'reports/:id',
        element: <CaseDetail kind="report" mode="student" />,
      },
      { path: 'complaints', element: <StudentComplaints /> },
      {
        path: 'complaints/:id',
        element: <CaseDetail kind="complaint" mode="student" />,
      },
      { path: 'suggestions', element: <StudentSuggestions /> },
      {
        path: 'requests',
        element: ph('My Requests', 'Phase D'),
      },
      {
        path: 'notifications',
  ...
  // EXCO PORTAL
  {
    path: '/exco',
    element: (
      <RequireRole roles={['exco', 'vp', 'president']}>
        <PortalLayout portal="exco" />
      </RequireRole>
    ),
    children: [
      ...
      {
        path: 'reports',
        element: <CaseInbox kind="report" scope="assigned" />,
      },
      {
        path: 'reports/:id',
        element: <CaseDetail kind="report" mode="exco" />,
      },
      {
        path: 'complaints',
        element: <CaseInbox kind="complaint" scope="assigned" />,
      },
      {
        path: 'complaints/:id',
        element: <CaseDetail kind="complaint" mode="exco" />,
      },
      { path: 'suggestions', element: <SuggestionsPanel /> },
      {
        path: 'tasks',
        element: <TasksPanel mode="officer" />,
      },
      {
        path: 'monthly-reports',
        element: <MonthlyReportsPanel mode="officer" />,
      },
      {
        path: 'directives',
        element: <DirectivesPanel mode="officer" />,
      },
      {
        path: 'requests',
        element: <RequestsPanel mode="officer" />,
      },
      {
        path: 'proposals',
        element: <ProposalsPanel mode="officer" />,
      },
      {
        path: 'achievements',
        element: <AchievementsPanel mode="officer" />,
      },
      ...
      {
        path: 'messages',
        element: ph('Messages', 'Phase G'),
      },
      {
        path: 'documents',
        element: ph('Documents', 'Phase G'),
      },
      { path: 'profile', element: <ProfilePage /> },
    ],
  },
  ...
  // VP PORTAL
  {
    path: '/vp',
    element: (
      <RequireRole roles={['vp', 'president']}>
        <PortalLayout portal="vp" />
      </RequireRole>
    ),
    children: [
      ...
      {
        path: 'reports',
        element: <CaseInbox kind="report" scope="administration" />,
      },
      {
        path: 'reports/:id',
        element: <CaseDetail kind="report" mode="president" />,
      },
      {
        path: 'directives',
        element: <DirectivesPanel mode="officer" />,
      ...
      {
        path: 'tasks',
        element: <TasksPanel mode="leadership" />,
      },
      {
        path: 'coordination',
        element: <TasksPanel mode="leadership" />,
  ...
  // PRESIDENT PORTAL
  {
    ...
    children: [
      ...
      {
        path: 'exco-management',
        element: <ExcoManagement />,
      },
      {
        path: 'administration',
        element: <AdministrationsManager />,
      },
      {
        path: 'reports',
        element: <CaseInbox kind="report" scope="administration" />,
      ...
      {
        path: 'suggestions',
        element: <SuggestionsPanel />,
      },
      {
        path: 'monthly-reports',
        element: (
          <MonthlyReportsPanel mode="president" />
        ),
      },
      {
        path: 'requests',
        element: <RequestsPanel mode="president" />,
      },
      {
        path: 'proposals',
        element: <ProposalsPanel mode="president" />,
      },
      {
        path: 'tasks',
        element: <TasksPanel mode="leadership" />,
      },
      {
        path: 'directives',
        element: (
          <DirectivesPanel mode="president" />
        ),
      },
      {
        path: 'escalations',
        element: <EscalationsPanel />,
      },
      {
        path: 'interventions',
      ...
      },
      {
        path: 'achievements',
        element: (
          <AchievementsPanel mode="president" />
        ),
      },
      {
        path: 'analytics',
      ...
      {
        path: 'transition',
        element: <TransitionPanel />,
      },
      {
        path: 'audit-logs',
        element: ph('Audit Logs', 'Phase H'),
      },
      {
        path: 'notifications',
        element: <NotificationsPanel />,
  ...
  // ADMIN PORTAL
  {
    ...
    children: [
      ...
      {
        path: 'users',
        element: ph('Users', 'Phase H'),
      },
      {
        path: 'roles',
        element: ph('Roles', 'Phase H'),
      },
      {
        path: 'permissions',
        element: ph('Permissions', 'Phase H'),
      },
      {
        path: 'directorates',
        element: ph('Directorates', 'Phase H'),
      },
      {
        path: 'positions',
        element: ph('Positions', 'Phase H'),
      },
      {
        path: 'routing',
        element: ph('Report Routing', 'Phase B part 2'),
      },
      {
        path: 'verification',
        element: ph('Verification Policy', 'Phase B part 2'),
      },
      {
        path: 'notifications',
        element: <NotificationsPanel />,
      ...
      {
        path: 'settings',
        element: ph('Institution Settings', 'Phase H'),
      },
      {
        path: 'audit-logs',
        element: ph('Audit Logs', 'Phase H'),
